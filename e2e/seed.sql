...
INSERT INTO store_profile (singleton_key, name, timezone, order_cutoff_minutes, created_at, updated_at)
VALUES (1, 'SupaShop Market', 'Asia/Kolkata', NULL, CAST(unixepoch('subsecond') * 1000 AS INTEGER), CAST(unixepoch('subsecond') * 1000 AS INTEGER));
